...
pairs = [
    ...
    [
        ...
        [ "Oceans protect biodiversity, provide jobs, food, drive economic growth, keep the planet cool, and absorbs about 3/10 of global CO2 emissions and we should keep them in good conditions.",
